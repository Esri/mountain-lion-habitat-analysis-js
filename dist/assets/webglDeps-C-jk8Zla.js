import{o as $}from"./BufferObject-CbyoCJeU.js";import{s as c}from"./Program-BgQmAx8n.js";import{m as b,a as y}from"./Program-BgQmAx8n.js";import{aD as g}from"./index-jlLiQgE8.js";import{e as F}from"./ShaderCompiler-G2XYGDs6.js";import{h as v}from"./VertexArrayObject-Bp1IpB9J.js";import{e as w}from"./ProgramTemplate-DWg6Swx_.js";class u{constructor(e){this._rctx=e,this._store=new Map}dispose(){this._store.forEach(e=>e.dispose()),this._store.clear()}acquire(e,r,t,n){const s=e+r+JSON.stringify(Array.from(t.entries())),o=this._store.get(s);if(o!=null)return o.ref(),o;const f=new c(this._rctx,e,r,t,n);return f.ref(),this._store.set(s,f),f}get test(){}}function p(i){const{options:e,value:r}=i;return typeof e[r]=="number"}function l(i){let e="";for(const r in i){const t=i[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
